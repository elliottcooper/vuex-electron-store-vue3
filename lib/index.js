...
class PersistedState {
    ...
    initIpcConnectionToMain(ipcRenderer) {
        ipcRenderer.invoke(helpers_1.ipcEvents.CONNECT);
        ...
        // })
        ipcRenderer.on(helpers_1.ipcEvents.GET_STATE, (event) => {
            console.log(this.store.state);
            console.log('sendingState');
            event.sender.send(helpers_1.ipcEvents.GET_STATE, JSON.stringify(this.store.state));
            // return this.store.state
        });
    }
    /**
