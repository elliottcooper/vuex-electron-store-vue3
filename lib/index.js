...
class PersistedState {
    ...
    initIpcConnectionToMain() {
        electron_1.ipcRenderer.invoke(helpers_1.ipcEvents.CONNECT);
        ...
        const storePromise = new Promise((resolve) => {
            ...
            const getState = () => {
                ...
                const pr = new Promise((res) => {
                    electron_1.ipcMain.handle(helpers_1.ipcEvents.GET_STATE, (event, data) => {
                        res(data);
                    });
                });
            ...
            electron_1.ipcMain.handle(helpers_1.ipcEvents.CONNECT, (event) => {
